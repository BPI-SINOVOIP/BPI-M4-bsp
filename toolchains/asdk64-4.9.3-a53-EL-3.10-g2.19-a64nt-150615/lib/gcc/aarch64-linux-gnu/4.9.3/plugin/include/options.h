...
enum opt_code
{
  ...
  OPT_mabi_ = 1081,                          /* -mabi= */
  OPT_march_ = 1082,                         /* -march= */
  OPT_mbig_endian = 1083,                    /* -mbig-endian */
  OPT_mbionic = 1084,                        /* -mbionic */
  OPT_mcmodel_ = 1085,                       /* -mcmodel= */
  OPT_mcpu_ = 1086,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1087,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1088,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1089,             /* -mgeneral-regs-only */
  OPT_mglibc = 1090,                         /* -mglibc */
  OPT_mlittle_endian = 1091,                 /* -mlittle-endian */
  OPT_mlra = 1092,                           /* -mlra */
  OPT_mmusl = 1093,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1094,       /* -momit-leaf-frame-pointer */
  OPT_mstrict_align = 1095,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1096,                  /* -mtls-dialect= */
  OPT_mtune_ = 1097,                         /* -mtune= */
  OPT_muclibc = 1098,                        /* -muclibc */
  OPT_n = 1099,                              /* -n */
  OPT_no_canonical_prefixes = 1100,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1101,              /* -no-integrated-cpp */
  OPT_nocpp = 1102,                          /* -nocpp */
  OPT_nodefaultlibs = 1103,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1104,                   /* -nostartfiles */
  OPT_nostdinc = 1105,                       /* -nostdinc */
  OPT_nostdinc__ = 1106,                     /* -nostdinc++ */
  OPT_nostdlib = 1107,                       /* -nostdlib */
  OPT_o = 1108,                              /* -o */
  OPT_p = 1109,                              /* -p */
  OPT_pass_exit_codes = 1110,                /* -pass-exit-codes */
  /* OPT_pedantic = 1111, */                 /* -pedantic */
  OPT_pedantic_errors = 1112,                /* -pedantic-errors */
  OPT_pg = 1113,                             /* -pg */
  OPT_pie = 1114,                            /* -pie */
  OPT_pipe = 1115,                           /* -pipe */
  OPT_posix = 1116,                          /* -posix */
  OPT_print_file_name_ = 1117,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1118,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1119,          /* -print-multi-directory */
  OPT_print_multi_lib = 1120,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1121,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1122,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1123,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1124,               /* -print-prog-name= */
  OPT_print_search_dirs = 1125,              /* -print-search-dirs */
  OPT_print_sysroot = 1126,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1127,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1128,                        /* -profile */
  OPT_pthread = 1129,                        /* -pthread */
  OPT_quiet = 1130,                          /* -quiet */
  OPT_r = 1131,                              /* -r */
  OPT_rdynamic = 1132,                       /* -rdynamic */
  OPT_remap = 1133,                          /* -remap */
  OPT_s = 1134,                              /* -s */
  OPT_s_bc_abi = 1135,                       /* -s-bc-abi */
  OPT_save_temps = 1136,                     /* -save-temps */
  OPT_save_temps_ = 1137,                    /* -save-temps= */
  OPT_shared = 1138,                         /* -shared */
  OPT_shared_libgcc = 1139,                  /* -shared-libgcc */
  /* OPT_specs = 1140, */                    /* -specs */
  OPT_specs_ = 1141,                         /* -specs= */
  OPT_static = 1142,                         /* -static */
  OPT_static_libasan = 1143,                 /* -static-libasan */
  OPT_static_libgcc = 1144,                  /* -static-libgcc */
  OPT_static_libgcj = 1145,                  /* -static-libgcj */
  OPT_static_libgfortran = 1146,             /* -static-libgfortran */
  OPT_static_libgo = 1147,                   /* -static-libgo */
  OPT_static_liblsan = 1148,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1149,               /* -static-libstdc++ */
  OPT_static_libtsan = 1150,                 /* -static-libtsan */
  OPT_static_libubsan = 1151,                /* -static-libubsan */
  /* OPT_std_c__03 = 1152, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1153, */                /* -std=c++0x */
  OPT_std_c__11 = 1154,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1155, */                /* -std=c++14 */
  OPT_std_c__1y = 1156,                      /* -std=c++1y */
  OPT_std_c__98 = 1157,                      /* -std=c++98 */
  OPT_std_c11 = 1158,                        /* -std=c11 */
  /* OPT_std_c1x = 1159, */                  /* -std=c1x */
  /* OPT_std_c89 = 1160, */                  /* -std=c89 */
  OPT_std_c90 = 1161,                        /* -std=c90 */
  OPT_std_c99 = 1162,                        /* -std=c99 */
  /* OPT_std_c9x = 1163, */                  /* -std=c9x */
  OPT_std_f2003 = 1164,                      /* -std=f2003 */
  OPT_std_f2008 = 1165,                      /* -std=f2008 */
  OPT_std_f2008ts = 1166,                    /* -std=f2008ts */
  OPT_std_f95 = 1167,                        /* -std=f95 */
  OPT_std_gnu = 1168,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1169, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1170, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1171,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1172, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1173,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1174,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1175,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1176, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1177, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1178,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1179,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1180, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1181, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1182,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1183, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1184, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1185, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1186,                     /* -std=legacy */
  OPT_symbolic = 1187,                       /* -symbolic */
  OPT_t = 1188,                              /* -t */
  OPT_time = 1189,                           /* -time */
  OPT_time_ = 1190,                          /* -time= */
  OPT_traditional = 1191,                    /* -traditional */
  OPT_traditional_cpp = 1192,                /* -traditional-cpp */
  OPT_trigraphs = 1193,                      /* -trigraphs */
  OPT_u = 1194,                              /* -u */
  OPT_undef = 1195,                          /* -undef */
  OPT_v = 1196,                              /* -v */
  OPT_version = 1197,                        /* -version */
  OPT_w = 1198,                              /* -w */
  OPT_wrapper = 1199,                        /* -wrapper */
  OPT_x = 1200,                              /* -x */
  OPT_z = 1201,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
