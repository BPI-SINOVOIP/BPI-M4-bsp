...
do
	...
	make Board_HWSETTING=$hwsetting CHIP_TYPE=$CHIP_TYPE
	cp ./examples/flash_writer_vm/install_a/hw_setting.bin ./DVRBOOT_OUT/hw_setting/$CHIP_TYPE-$hwsetting.bin
	cp ./examples/flash_writer_vm/Bind/emmc.bind.bin ./DVRBOOT_OUT/hw_setting/Recovery-A02-$hwsetting.bin
	cp ./examples/flash_writer_vm/dvrboot.exe.bin ./DVRBOOT_OUT/A02-$hwsetting.bin

	#Build the drm version
	cp ./examples/flash_writer_vm/image/tee_os/$CHIP_TYPE/fsbl-os-00.00.bin.drm.enc ./examples/flash_writer_vm/bootimage/rtd1395/$CHIP_TYPE/fsbl-os-00.00.bin.enc
	make Board_HWSETTING=$hwsetting CHIP_TYPE=$CHIP_TYPE
	cp ./examples/flash_writer_vm/Bind/emmc.bind.bin ./DVRBOOT_OUT/hw_setting/Recovery-A02-$hwsetting-drm.bin
	cp ./examples/flash_writer_vm/dvrboot.exe.bin ./DVRBOOT_OUT/A02-$hwsetting-drm.bin

	#Build the atv version
	cp ./examples/flash_writer_vm/image/tee_os/$CHIP_TYPE/fsbl-os-00.00.bin.atv.enc ./examples/flash_writer_vm/bootimage/rtd1395/$CHIP_TYPE/fsbl-os-00.00.bin.enc
	make Board_HWSETTING=$hwsetting CHIP_TYPE=$CHIP_TYPE
	cp ./examples/flash_writer_vm/Bind/emmc.bind.bin ./DVRBOOT_OUT/hw_setting/Recovery-A02-$hwsetting-atv.bin
	cp ./examples/flash_writer_vm/dvrboot.exe.bin ./DVRBOOT_OUT/A02-$hwsetting-atv.bin

	#Build the vmx version
	cp ./examples/flash_writer_vm/image/tee_os/$CHIP_TYPE/fsbl-os-00.00.bin.vmx.enc ./examples/flash_writer_vm/bootimage/rtd1395/$CHIP_TYPE/fsbl-os-00.00.bin.enc
	make Board_HWSETTING=$hwsetting CHIP_TYPE=$CHIP_TYPE
	cp ./examples/flash_writer_vm/Bind/emmc.bind.bin ./DVRBOOT_OUT/hw_setting/Recovery-A02-$hwsetting-vmx.bin
	cp ./examples/flash_writer_vm/dvrboot.exe.bin ./DVRBOOT_OUT/A02-$hwsetting-vmx.bin
